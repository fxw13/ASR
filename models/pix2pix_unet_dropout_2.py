...
class ResnetGenerator(nn.Module):
    ...
    def forward(self, input):
        out = {}
        out['in'] = self.dropout(self.inc(input))
        out['d1'] = self.dropout(self.down1(out['in']))
        out['d2'] = self.dropout(self.down2(out['d1']))

        out['bottle'] = self.dropout(self.resblocks(out['d2']))
        out['u1'] = self.dropout(self.up1(out['bottle']))
        out['u2'] = self.dropout(self.up2(out['u1']))
